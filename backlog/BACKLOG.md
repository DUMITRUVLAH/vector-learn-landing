...
| VM4-07 | high | Formularul PAR scris pe server (text, nu fotografie) + mereu în dosar | done | [catalog](specs/VM4-catalog.md) |
| VM4-08 | low | Curățenie: ștergerea generatorului de formular din browser | pending | [catalog](specs/VM4-catalog.md) |
| VM4-09 | high | Pătratele din documente: font complet (chirilice) + auditul fără „?" | done | [catalog](specs/VM4-catalog.md) |

---

## Milestone VM5 — Ședința de prezentare cu toți utilizatorii (2026-09-10)

> Sursă: notițele din ședința de prezentare a aplicației către toți utilizatorii — 21 de cerințe.
> Fiecare a fost verificată în cod pe `origin/main` înainte de a fi scrisă. Catalog cu stare azi,
> ce construiesc și AC: [`specs/VM5-catalog.md`](specs/VM5-catalog.md).
>
> Semafor: 🟢 = construiesc fără alte întrebări · 🟡 = construiesc pe o presupunere declarată ·
> 🔴 = blocat pe o decizie (owner) sau pe un răspuns (Ana).
...
| VM5-08 | high | „Pachet audit": registru XLSX + dosarele PDF + actele, pe interval | ✅ done | [catalog](specs/VM5-catalog.md) |
| VM5-09 | medium | Ecran „Activitatea" (ce a făcut o persoană, cu export) | ✅ done | [catalog](specs/VM5-catalog.md) |
...
| 6 | `DG-120` | Dosarul proiectului (acte pe contraparte, contractat vs plătit, ZIP) | done ✅ | [backlog](docgen/DOCGEN-BACKLOG.md) |
