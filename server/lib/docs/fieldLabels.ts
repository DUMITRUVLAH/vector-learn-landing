...
const LABELS: Record<string, string> = {
  ...
  "noi.functie": "Funcția administratorului nostru",
  "noi.bic": "Codul nostru bancar (BIC)",
  "noi.cod_tva": "Codul nostru TVA",
  "noi.telefon": "Telefonul nostru",
  "noi.email": "E-mailul nostru",
  "contraparte.denumire": "Denumirea furnizorului",
  "contraparte.idno": "Codul fiscal al furnizorului",
  "contraparte.iban": "IBAN furnizor",
  "contraparte.banca": "Banca furnizorului",
  "contraparte.bic": "Codul bancar (BIC/SWIFT)",
  "contraparte.adresa": "Adresa juridică a furnizorului",
  "contraparte.administrator": "Administratorul furnizorului",
