...
6. documentClass: eticheta tipului de act, DOAR informativ: "invoice" (factură/cont de plată),
   "receipt" (chitanță/bon), "not_invoice" (orice alt act: contract, act de primire-predare,
   proces-verbal, deviz). Această etichetă NU oprește extragerea: chiar și pentru "not_invoice"
   completează părțile, rechizitele, suma și articolele, dacă apar în document.
