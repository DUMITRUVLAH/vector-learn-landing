...
import { finMembers, finOrgProfile } from "../db/schema/finCore";
 ...
 * CORE-004: used by FinLayout to determine role and render gating.
 * Returns 403 if user has no FinDesk member record.
 */
finMembersRoutes.get("/me", async (c) => {
  ...
  // Also include org profile for the layout header
