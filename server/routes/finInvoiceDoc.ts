 ...
 *
 * The old ad-hoc POST /document.{html,pdf} generator (no number, nothing saved, Chromium-only
 * PDF) was replaced by the CRM payment-accounts module (CONTPLATA-faza-1, /api/payment-accounts).
 *
