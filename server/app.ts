...
import { parToInvoiceRoutes } from "./routes/parToInvoice";
...
// PAR-FIN-001: PAR → FinDesk invoice bridge — mount before the catch-all parRoutes.
app.route("/api/par", parToInvoiceRoutes);
