...
import { finCapturesRoutes } from "./routes/finCaptures"; // CAPTURE-002: OCR AI captures
...
// CAPTURE-002: FinDesk OCR AI captures
// /api/fin/captures — POST (upload), GET /:id, POST /:id/confirm
