...
import { Users, Calendar, GraduationCap, CreditCard, LogOut, LayoutDashboard, TrendingUp, Zap, BarChart3, MessageSquareHeart } from "lucide-react";
...
const NAV = [
  ...
  { label: "Feedback", href: "/app/feedback", icon: MessageSquareHeart },
