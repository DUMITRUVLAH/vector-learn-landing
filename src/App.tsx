...
import { FinInvoicesPage } from "./pages/app/FinInvoicesPage"; // BILL-005: FinDesk B2B invoices
...
function Routes() {
  ...
  // BILL-005: FinDesk B2B invoices (/app/fin/invoices — separate from student B2C invoices)
