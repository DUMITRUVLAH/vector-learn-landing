...
import { FinEinvoicesPage } from "./pages/app/FinEinvoicesPage"; // EINV-003: e-Factura SFS
...
function Routes() {
  ...
  if (path.startsWith("/app/fin/einvoices")) return <FinEinvoicesPage />; // EINV-003: SFS e-Factura MD
