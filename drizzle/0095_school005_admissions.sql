...
CREATE INDEX IF NOT EXISTS "admission_applications_tenant_year_status_idx" ON "admission_applications" USING btree ("tenant_id","academic_year_id","status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "admission_applications_tenant_status_idx" ON "admission_applications" USING btree ("tenant_id","status");--> statement-breakpoint
