...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "users_tenant_email_uniq" ON "users" USING btree ("tenant_id","email");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "students_tenant_idx" ON "students" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "students_status_idx" ON "students" USING btree ("tenant_id","status");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "students_name_idx" ON "students" USING btree ("tenant_id","full_name");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "teachers_tenant_idx" ON "teachers" USING btree ("tenant_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lessons_tenant_idx" ON "lessons" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lessons_teacher_time_idx" ON "lessons" USING btree ("teacher_id","scheduled_at");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lessons_time_idx" ON "lessons" USING btree ("tenant_id","scheduled_at");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "sl_tenant_idx" ON "student_lessons" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "sl_lesson_idx" ON "student_lessons" USING btree ("lesson_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "sl_student_idx" ON "student_lessons" USING btree ("student_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "payments_tenant_idx" ON "payments" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "payments_student_idx" ON "payments" USING btree ("student_id");
--> statement-breakpoint
