...
CREATE INDEX IF NOT EXISTS "school_subjects_tenant_idx" ON "school_subjects" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "grade_entries_tenant_class_student_idx" ON "grade_entries" USING btree ("tenant_id","class_id","student_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "grade_entries_tenant_student_term_idx" ON "grade_entries" USING btree ("tenant_id","student_id","term_id");--> statement-breakpoint
