...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lesson_homework_tenant_idx" ON "lesson_homework" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lesson_homework_lesson_idx" ON "lesson_homework" USING btree ("lesson_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "homework_submissions_tenant_idx" ON "homework_submissions" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "homework_submissions_homework_idx" ON "homework_submissions" USING btree ("homework_id");
--> statement-breakpoint
