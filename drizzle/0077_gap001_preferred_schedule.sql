...
ALTER TABLE "tenants" ADD COLUMN IF NOT EXISTS "rot_days" integer DEFAULT 7 NOT NULL;--> statement-breakpoint
ALTER TABLE "students" ADD COLUMN IF NOT EXISTS "debt_cents" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "students" ADD COLUMN IF NOT EXISTS "preferred_days" jsonb;--> statement-breakpoint
ALTER TABLE "students" ADD COLUMN IF NOT EXISTS "preferred_time_start" time;--> statement-breakpoint
ALTER TABLE "students" ADD COLUMN IF NOT EXISTS "preferred_time_end" time;--> statement-breakpoint
ALTER TABLE "leads" ADD COLUMN IF NOT EXISTS "preferred_days" jsonb;--> statement-breakpoint
ALTER TABLE "leads" ADD COLUMN IF NOT EXISTS "preferred_time_start" time;--> statement-breakpoint
ALTER TABLE "leads" ADD COLUMN IF NOT EXISTS "preferred_time_end" time;--> statement-breakpoint
ALTER TABLE "pipeline_stages" ADD COLUMN IF NOT EXISTS "probability_pct" integer DEFAULT 10 NOT NULL;--> statement-breakpoint
DO $$ BEGIN
...
CREATE INDEX IF NOT EXISTS "notif_user_idx" ON "notifications" USING btree ("user_id","is_read","created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "sv_tenant_idx" ON "saved_views" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "sv_user_idx" ON "saved_views" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "lce_cadence_idx" ON "lead_cadence_enrollments" USING btree ("cadence_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "cal_actor_idx" ON "crm_audit_log" USING btree ("tenant_id","actor_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "contracts_student_idx" ON "contracts" USING btree ("student_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "feedback_answers_invitation_idx" ON "feedback_answers" USING btree ("invitation_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "feedback_answers_question_idx" ON "feedback_answers" USING btree ("question_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "feedback_forms_tenant_idx" ON "feedback_forms" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "feedback_invitations_form_idx" ON "feedback_invitations" USING btree ("form_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "feedback_invitations_student_idx" ON "feedback_invitations" USING btree ("student_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "feedback_invitations_token_idx" ON "feedback_invitations" USING btree ("token");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "feedback_questions_form_idx" ON "feedback_questions" USING btree ("form_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "invoices_number_idx" ON "invoices" USING btree ("tenant_id","number");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "subscriptions_tenant_idx" ON "subscriptions" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "subscriptions_student_idx" ON "subscriptions" USING btree ("student_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "subscriptions_status_idx" ON "subscriptions" USING btree ("tenant_id","status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "subscriptions_billing_idx" ON "subscriptions" USING btree ("tenant_id","next_billing_date");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cohorts_tenant_course_idx" ON "cohorts" USING btree ("tenant_id","course_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cohorts_tenant_start_idx" ON "cohorts" USING btree ("tenant_id","start_date");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "cohort_participants_cohort_idx" ON "cohort_participants" USING btree ("cohort_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cert_tmpl_tenant_global_idx" ON "certificate_templates" USING btree ("tenant_id","is_global");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cert_tmpl_tenant_course_idx" ON "certificate_templates" USING btree ("tenant_id","course_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "issued_cert_tenant_idx" ON "issued_certificates" USING btree ("tenant_id");--> statement-breakpoint
