...
ALTER TABLE "lessons" ADD COLUMN IF NOT EXISTS "room_id" uuid;
--> statement-breakpoint
DO $$
BEGIN
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "rooms_tenant_idx" ON "rooms" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "rooms_name_idx" ON "rooms" USING btree ("tenant_id","name");
--> statement-breakpoint
DO $$
BEGIN
