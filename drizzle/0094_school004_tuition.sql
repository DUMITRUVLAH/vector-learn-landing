...
CREATE INDEX IF NOT EXISTS "tuition_plans_tenant_year_idx" ON "tuition_plans" USING btree ("tenant_id","academic_year_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tuition_installments_tenant_plan_idx" ON "tuition_installments" USING btree ("tenant_id","plan_id");--> statement-breakpoint
