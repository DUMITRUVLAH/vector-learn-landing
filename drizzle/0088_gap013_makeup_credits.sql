...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "makeup_tenant_idx" ON "makeup_credits" ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "makeup_student_idx" ON "makeup_credits" ("tenant_id","student_id");
--> statement-breakpoint
