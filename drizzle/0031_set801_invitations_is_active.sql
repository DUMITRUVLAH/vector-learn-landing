...
CREATE INDEX "invitations_email_tenant_idx" ON "invitations" USING btree ("tenant_id","email");--> statement-breakpoint
CREATE INDEX "users_is_active_idx" ON "users" USING btree ("tenant_id","is_active");
