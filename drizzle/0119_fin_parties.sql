-- MASS-003: FinDesk business partners (fin_parties + fin_party_contacts)
-- Copied from feat/FIN-party (originally 0115 there; renumbered 0119 here to avoid collision).
-- COLLISION NOTE: feat/FIN-party uses 0115_fin_parties.sql — must renumber at merge.
