...
--> statement-breakpoint
ALTER TABLE "leads" ADD COLUMN IF NOT EXISTS "assigned_to" uuid;--> statement-breakpoint
ALTER TABLE "leads" ADD COLUMN IF NOT EXISTS "consent_revoked_at" timestamp with time zone;--> statement-breakpoint
DO $$ BEGIN
...
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ps_tenant_idx" ON "pipeline_stages" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ps_key_idx" ON "pipeline_stages" USING btree ("tenant_id","key");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "la_tenant_idx" ON "lead_attachments" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "la_lead_idx" ON "lead_attachments" USING btree ("lead_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lt_tenant_idx" ON "lead_tasks" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lt_lead_idx" ON "lead_tasks" USING btree ("lead_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lt_status_idx" ON "lead_tasks" USING btree ("tenant_id","status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "mt_tenant_idx" ON "message_templates" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "mt_channel_idx" ON "message_templates" USING btree ("tenant_id","channel");--> statement-breakpoint
DO $$ BEGIN
