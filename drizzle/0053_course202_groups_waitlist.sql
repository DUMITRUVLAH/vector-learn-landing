...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "groups_tenant_idx" ON "groups" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "groups_course_idx" ON "groups" USING btree ("course_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "groups_tenant_course_idx" ON "groups" USING btree ("tenant_id","course_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ge_group_idx" ON "group_enrollments" USING btree ("group_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ge_student_idx" ON "group_enrollments" USING btree ("student_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ge_tenant_idx" ON "group_enrollments" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "gw_group_idx" ON "group_waitlist" USING btree ("group_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "gw_student_idx" ON "group_waitlist" USING btree ("student_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "gw_tenant_idx" ON "group_waitlist" USING btree ("tenant_id");
--> statement-breakpoint
