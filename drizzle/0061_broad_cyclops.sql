...
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "hw_tenant_idx" ON "homework" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "hw_student_idx" ON "homework" USING btree ("student_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "hw_lesson_idx" ON "homework" USING btree ("lesson_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "hw_deadline_idx" ON "homework" USING btree ("student_id","deadline");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "hws_tenant_idx" ON "homework_submissions" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "hws_homework_idx" ON "homework_submissions" USING btree ("homework_id");--> statement-breakpoint
