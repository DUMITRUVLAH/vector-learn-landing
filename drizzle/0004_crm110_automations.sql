DO $$ BEGIN
  CREATE TYPE "public"."automation_run_status" AS ENUM('ok', 'failed', 'skipped');
...
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ar_tenant_idx" ON "automation_runs" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ar_auto_idx" ON "automation_runs" USING btree ("automation_id","ran_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ar_lead_idx" ON "automation_runs" USING btree ("lead_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "auto_tenant_idx" ON "automations" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "auto_enabled_idx" ON "automations" USING btree ("tenant_id","enabled");