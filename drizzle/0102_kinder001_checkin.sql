...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "authorized_pickups_tenant_idx" ON "authorized_pickups" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "authorized_pickups_student_idx" ON "authorized_pickups" USING btree ("student_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "checkin_log_tenant_idx" ON "checkin_log" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "checkin_log_student_date_idx" ON "checkin_log" USING btree ("student_id","log_date");
--> statement-breakpoint
