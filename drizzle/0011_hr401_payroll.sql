...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pe_tenant_idx" ON "payroll_entries" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pe_teacher_idx" ON "payroll_entries" USING btree ("teacher_id");
--> statement-breakpoint
