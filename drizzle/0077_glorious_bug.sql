...
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lm_tenant_idx" ON "lead_mentions" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lm_lead_idx" ON "lead_mentions" USING btree ("lead_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lm_interaction_idx" ON "lead_mentions" USING btree ("interaction_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "lm_user_idx" ON "lead_mentions" USING btree ("mentioned_user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ian_tenant_idx" ON "in_app_notifications" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ian_recipient_idx" ON "in_app_notifications" USING btree ("recipient_user_id");--> statement-breakpoint
