...
--> statement-breakpoint
ALTER TABLE "courses" ADD COLUMN IF NOT EXISTS "status" "course_status" DEFAULT 'active' NOT NULL;--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "form_logic_from_field_idx" ON "form_logic" USING btree ("from_field_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "sn_tenant_student_idx" ON "student_notes" USING btree ("tenant_id","student_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "sn_created_at_idx" ON "student_notes" USING btree ("tenant_id","student_id","created_at");--> statement-breakpoint
