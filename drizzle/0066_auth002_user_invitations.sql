...
CREATE INDEX "ui_tenant_idx" ON "user_invitations" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "ui_email_idx" ON "user_invitations" USING btree ("tenant_id","email");