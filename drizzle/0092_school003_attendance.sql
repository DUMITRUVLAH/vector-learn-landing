...
CREATE INDEX IF NOT EXISTS "attendance_sessions_tenant_class_date_idx" ON "attendance_sessions" USING btree ("tenant_id","class_id","date");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "attendance_records_tenant_student_idx" ON "attendance_records" USING btree ("tenant_id","student_id");--> statement-breakpoint
