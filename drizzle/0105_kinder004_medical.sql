...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "child_allergies_tenant_idx" ON "child_allergies" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "child_allergies_student_idx" ON "child_allergies" USING btree ("student_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "immunization_records_tenant_idx" ON "immunization_records" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "immunization_records_student_idx" ON "immunization_records" USING btree ("student_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "immunization_records_due_date_idx" ON "immunization_records" USING btree ("next_due_date");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "medication_log_tenant_idx" ON "medication_log" USING btree ("tenant_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "medication_log_student_date_idx" ON "medication_log" USING btree ("student_id","log_date");
--> statement-breakpoint
